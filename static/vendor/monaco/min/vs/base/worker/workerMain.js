    ...
    class A {
      ...
      _applyPaths(d) {
        ...
        for (let p = 0, h = this.sortedPathsRules.length; p < h; p++)
          if (
            ((b = this.sortedPathsRules[p]), q.Utilities.startsWith(d, b.from))
          ) {
            let o = [];
      ...
      requireToUrl(d) {
        ...
        return (
          q.Utilities.isAbsolutePath(b) ||
            ...
            q.Utilities.isAbsolutePath(b) || (b = this.options.baseUrl + b)),
...
//# sourceURL=${L}`),
    ...
    class d {
      ...
      _getElectronRendererScriptPathOrUri(o) {
        ...
        let L = o.match(/^([a-z])\:(.*)/i);
        return L
          ? `file:///${(L[1].toUpperCase() + ":" + L[2]).replace(/\\/g, "/")}`
          : `file://${o}`;
      }
      ...
      _createAndWriteCachedData(o, L, e, a) {
        ...
        const y = () => {
          setTimeout(
            () => {
              f ||
                (f = this._crypto.createHash("md5").update(L, "utf8").digest());
        ...
        if (!L) this._fs.readFile(o, { encoding: "utf8" }, a);
          ...
          (this._fs.readFile(o, { encoding: "utf8" }, (w, E) => {
            ...
            this._fs.readFile(L, (w, E) => {
              (!w && E && E.length > 0
                ? ((m = E.slice(0, 16)), (c = E.slice(16)), e.record(60, L))
                : e.record(61, L),
                y());
            }));
        }
      ...
      function c(f, y) {
        ...
        return {
          ...
          getConfiguredDefaultLocale:
            (w = y.getConfiguredDefaultLocale) !== null && w !== void 0
              ? w
              : (E) => {},
        };
      }
      ...
      function m(f, y, w, E) {
        ...
        if (!f || f.length === 0)
          return w({
            ...
            getConfiguredDefaultLocale: () => {
              var g;
              return (g = C.availableLanguages) === null || g === void 0
                ? void 0
                : g["*"];
            },
          });
        ...
        const _ = (g) => {
          (Array.isArray(g)
            ...
            (g.getConfiguredDefaultLocale = () => {
              var v;
              return (v = C.availableLanguages) === null || v === void 0
                ? void 0
                : v["*"];
            }),
            w(g));
            ...
            ? (async () => {
                ...
                try {
                  ...
                  try {
                    ...
                    return (
                      ((g = C.availableLanguages) !== null && g !== void 0) ||
...
//# sourceURL=${a}`),
    ...
    Y(X[7], J([0, 1]), function (q, n) {
      ...
      function* L(k, O) {
        let I, W;
        for (const z of k)
          (W !== void 0 && O(W, z) ? I.push(z) : (I && (yield I), (I = [z])),
            (W = z));
        I && (yield I);
      }
      n.groupAdjacentBy = L;
      ...
      class V {
        ...
        findLastMaxBy(O) {
          ...
          return (
            this.iterate(
              (z) => (
                (W || R.isGreaterThan(O(z, I))) && ((W = !1), (I = z)),
                !0
              ),
            ),
            I
    ...
    Y(X[33], J([0, 1]), function (q, n) {
      ...
      class i {
        ...
        static fromRGBA(h) {
          ...
          if (w > 0) {
            switch (
              ((f = Math.min(y <= 0.5 ? w / (2 * y) : w / (2 - 2 * y), 1)), u)
            ) {
              case o:
                m = (L - e) / w + (L < e ? 6 : 0);
                break;
...
` +
    ...
    Y(X[21], J([0, 1]), function (q, n) {
      ...
      (function (A) {
        function i(r) {
          return (
            r && typeof r == "object" && typeof r[Symbol.iterator] == "function"
          );
        }
        A.is = i;
        ...
        function* E(r, s, l = r.length) {
          for (
            s < 0 && (s += r.length),
              l < 0 ? (l += r.length) : l > r.length && (l = r.length);
            s < l;
            s++
          )
            yield r[s];
    ...
    Y(X[9], J([0, 1, 5, 20, 13, 22, 23]), function (q, n, M, A, i, d, b) {
      ...
      (function (g) {
          ...
          return (j, Z = null, Q) => {
            ...
            return (
              (ne = K(
                (ie) => {
                  if (!ee)
                    return (ne ? ne.dispose() : (ee = !0), j.call(Z, ie));
                },
                null,
                Q,
              )),
        ...
        function D(K, j, Z) {
          return k(
            (Q, ee = null, ne) => K((ie) => Q.call(ee, j(ie)), null, ne),
            Z,
          );
        }
        g.map = D;
        ...
        function T(K, j, Z) {
          return k(
            (Q, ee = null, ne) => K((ie) => j(ie) && Q.call(ee, ie), null, ne),
            Z,
          );
        }
        g.filter = T;
          ...
          return (j, Z, Q) => {
            ...
            const ie = {
              ...
              endUpdate() {
                (ee--,
                  ee === 0 &&
                    (K.reportChanges(), ne && ((ne = !1), j.call(Z))));
              },
      ...
      class u {
        static create() {
          var v;
          return new u(
            (v = new Error().stack) !== null && v !== void 0 ? v : "",
          );
        }
        constructor(v) {
          this.value = v;
...
`),
            ...
            for (let k = 0; k < T.length; k++)
              T[k]
                ...
                : B &&
                  ...
                  V < this._deliveryQueue.i && this._deliveryQueue.i--);
            T.length = V;
          }
        }
        _deliver(v, R) {
      ...
      class S extends y {
        ...
        fire(v) {
          this._size &&
            (this._isPaused !== 0 ? this._eventQueue.push(v) : super.fire(v));
        }
      }
      ...
      class C extends S {
        constructor(v) {
          var R;
          (super(v),
            (this._delay = (R = v.delay) !== null && R !== void 0 ? R : 100));
        }
        fire(v) {
          (this._handle ||
            (this.pause(),
    ...
    Y(X[6], J([0, 1, 32, 36]), function (q, n, M, A) {
      ...
      function u(P, U) {
        ...
        for (
          ;
          (re = P.lastIndexOf(U, te - 1)), !(re === -1 || re + H !== te);
        ) {
          if (re === 0) return "";
          te = re;
        }
      ...
      function _(P, U, H = 0, $ = P.length, te = 0, re = U.length) {
        for (; H < $ && te < re; H++, te++) {
          ...
          if (fe === oe) continue;
          if (fe >= 128 || oe >= 128)
            return s(P.toLowerCase(), U.toLowerCase(), H, $, te, re);
          ...
          for (let B = 1; B <= l / 2 + 1; B++) {
            ...
            for (let I = S; I <= C; I += 2) {
              (I === S || (I < C && g[I - 1] < g[I + 1])
                ...
                (E = w - (I - R) - D));
              const W = w;
              for (; w < a && E < c && this.ElementsAreEqual(w + 1, E + 1); )
                (w++, E++);
              if (
                ((g[I] = w),
                w + E > V + k && ((V = w), (k = E)),
            ...
            for (let I = r; I <= s; I += 2) {
              (I === r || (I < s && v[I - 1] >= v[I + 1])
                ...
                (E = w - (I - N) - x));
              const W = w;
              for (; w > e && E > u && this.ElementsAreEqual(w, E); )
                (w--, E--);
    ...
    Y(X[25], J([0, 1]), function (q, n) {
      ...
      function e(f, y) {
        if (!f)
          throw new Error(
            y ? `Unexpected type, expected '${y}'` : "Unexpected type",
          );
      }
      n.assertType = e;
      function a(f) {
    ...
    Y(X[40], J([0, 1, 25]), function (q, n, M) {
      ...
      function i(b, p) {
        if ((0, M.isString)(p)) {
          const h = A[p];
          if (h === void 0)
            throw new Error(`${b} references an unknown codicon: ${p}`);
          p = h;
        }
        return ((A[b] = p), { id: b });
      }
    ...
    Y(X[43], J([0, 1, 7, 3, 8]), function (q, n, M, A, i) {
            ...
            for (
              ...
              !(
                c.getElement(C.seq1Range.start - s) !==
                  c.getElement(C.seq1Range.endExclusive - s) ||
      ...
      function L(c, m, f) {
        ...
        function S(r, s) {
          ...
          for (; y.length > 0; ) {
            const D = y[0];
            if (!(D.seq1Range.intersects(l) || D.seq2Range.intersects(_)))
              break;
        ...
        for (; y.length > 0; ) {
          const r = y.shift();
          r.seq1Range.isEmpty ||
            (S(r.getStarts(), r), S(r.getEndExclusives().delta(-1), r));
        }
        return e(f, w);
      }
        ...
        do {
          ...
          for (let C = 1; C < y.length; C++) {
            ...
            const r = y[C],
              s = S[S.length - 1];
            l(s, r)
              ? ((E = !0), (S[S.length - 1] = S[S.length - 1].join(r)))
              : S.push(r);
          }
          y = S;
        } while (w++ < 10 && E);
        ...
        do {
          ...
          for (let r = 1; r < y.length; r++) {
            let _ = function (v, R) {
              ...
              return (
                Math.pow(
                  Math.pow(G(T * 40 + F), 1.5) + Math.pow(G(B * 40 + V), 1.5),
                  1.5,
                ) +
                  Math.pow(
                    Math.pow(G(k * 40 + O), 1.5) + Math.pow(G(I * 40 + W), 1.5),
                    1.5,
                  ) >
                (z ** 1.5) ** 1.5 * 1.3
              );
            ...
            const s = y[r],
              l = C[C.length - 1];
            _(l, s)
              ? ((E = !0), (C[C.length - 1] = C[C.length - 1].join(s)))
              : C.push(s);
          }
          y = C;
        } while (w++ < 10 && E);
    ...
    Y(X[15], J([0, 1]), function (q, n) {
      ...
      class i {
        static getKey(b) {
          ...
          return (
            p === void 0 && ((p = this.chrKeys.size), this.chrKeys.set(b, p)),
            p
          );
        }
        constructor(b, p, h) {
        ...
        compute(p, h, o = A.InfiniteTimeout.instance, L) {
          ...
          for (let S = 0; S < p.length; S++)
            for (let C = 0; C < h.length; C++) {
              if (!o.isValid())
                return A.DiffAlgorithmResult.trivialTimedOut(p, h);
...
`.charCodeAt(0),
              ...
              (this.firstCharOffsetByLine[y - this.lineRange.start + 1] =
        ...
        findWordContaining(u) {
          if (u < 0 || u >= this.elements.length || !h(this.elements[u]))
            return;
          let c = u;
          ...
          for (let x = 0; x < _.length; x++) {
            const T = _[x],
              F = D.findLastMonotonous(
                (G) => G.original.startLineNumber <= T.original.startLineNumber,
              ),
              B = (0, d.findLastMonotonous)(
                E,
                (G) => G.modified.startLineNumber <= T.modified.startLineNumber,
              ),
              V = Math.max(
        ...
        function y(E) {
          ...
          for (let C = 1; C < E.length; C++) {
            const r = S[S.length - 1],
              ...
              _ =
                s.modified.startLineNumber - r.modified.endLineNumberExclusive;
            if (l >= 0 && _ >= 0 && l + _ <= 2) {
    ...
    Y(
      ...
      function (q, n, M, A, i, d, b, p, h, o, L, e, a, u, c, m) {
        ...
        class f {
          ...
          computeDiff(S, C, r) {
            if (S.length <= 1 && (0, M.equals)(S, C, (z, G) => z === G))
            ...
            for (const z of T) {
              (0, A.assertFn)(
                () => z.seq1Range.start - k === z.seq2Range.start - O,
              );
        ...
        class a {
          ...
          createCharSequence(r, s, l) {
            ...
            for (let N = s; N <= l; N++) {
              ...
              for (let F = x; F < T; F++)
                ((_[R] = D.charCodeAt(F - 1)), (g[R] = N + 1), (v[R] = F), R++);
              !r &&
                N < l &&
                ((_[R] = 10), (g[R] = N + 1), (v[R] = D.length + 1), R++);
            }
            return new u(_, g, v);
          }
        }
          ...
          _mergeTrimWhitespaceCharChange(r, s, l, _, g, v, R) {
            ...
            return D.originalEndLineNumber === 0 ||
              ...
              : D.originalEndLineNumber === s && D.modifiedEndLineNumber === g
                ? (this.shouldComputeCharChanges &&
                    D.charChanges &&
                    D.charChanges.push(new c(s, l, s, _, g, v, g, R)),
                  !0)
      ...
      class d {
        ...
        _acceptInsertText(p, h) {
          ...
          ((o[o.length - 1] += this._lines[p.lineNumber - 1].substring(
            ...
            this._setLineText(
              p.lineNumber - 1,
              this._lines[p.lineNumber - 1].substring(0, p.column - 1) + o[0],
            ));
      ...
      class a {
        ...
        static _getMultilineMatchRange(w, E, S, C, r, s) {
          let l,
            _ = 0;
          C
            ? ((_ = C.findLineFeedCountBeforeOffset(r)), (l = E + r + _))
            : (l = E + r);
          let g;
          if (C) {
...
`
          ...
          for (S.reset(0); (R = S.next(l)); )
            if (
              ((g[v++] = L(
                this._getMultilineMatchRange(w, s, l, _, R.index, R[0]),
                R,
                C,
              )),
              v >= r)
...
`
        ...
        static _findFirstMatchInLine(w, E, S, C, r) {
          ...
          const s = w.next(E);
          return s
            ? L(new d.Range(S, s.index + 1, S, s.index + 1 + s[0].length), s, r)
            : null;
        }
        ...
        static _findLastMatchInLine(w, E, S, C) {
          ...
          for (w.reset(0); (s = w.next(E)); )
            r = L(
              new d.Range(S, s.index + 1, S, s.index + 1 + s[0].length),
              s,
              C,
            );
          return r;
...
` ||
    ...
    Y(X[58], J([0, 1]), function (q, n) {
      ...
      (function (t) {
        ((t[(t.acceptSuggestionOnCommitCharacter = 0)] =
          ...
          (t[(t.find = 41)] = "find"),
          (t[(t.fixedOveripelineWidgets = 42)] = "fixedOveripelineWidgets"),
    ...
    Y(X[63], J([0, 1, 62]), function (q, n, M) {
      ...
      n.win32 = {
        resolve(...r) {
          ...
          for (let g = r.length - 1; g >= -1; g--) {
            ...
            if (_) {
              ...
              ((l = `${v.slice(N)}\\${l}`), (_ = x), x && s.length > 0)
            )
              break;
          }
          return (
        ...
        isAbsolute(r) {
          ...
          return (
            f(l) ||
            (s > 2 && w(l) && r.charCodeAt(1) === L && f(r.charCodeAt(2)))
          );
        },
        join(...r) {
        ...
        relative(r, s) {
          ...
          if (B !== T) {
            ...
            (R > T &&
              (r.charCodeAt(g + B) === o ? (F = B) : B === 2 && (F = 3)),
              F === -1 && (F = 0));
          }
          let V = "";
          for (B = g + F + 1; B <= v; ++B)
      ...
      class u {
        ...
        static file(_) {
          ...
          if (
            ...
            v === -1
              ? ((g = _.substring(2)), (_ = e))
              : ((g = _.substring(2, v)), (_ = _.substring(v) || e));
          }
          ...
          if (_) {
            if (_ instanceof u) return _;
            {
              ...
              return (
                ...
                (R._fsPath =
                  _._sep === c && (v = _.fsPath) !== null && v !== void 0
                    ? v
                    : null),
                R
              );
      ...
      function y(l, _, g) {
        ...
        for (let N = 0; N < l.length; N++) {
          ...
          if (
            ...
            (R !== -1 &&
              ((v += encodeURIComponent(l.substring(R, N))), (R = -1)),
      ...
      function S(l, _) {
        ...
        if (
          ...
          ((N = N.toLowerCase()),
            ...
            F === -1
              ? (v += g(N, !1, !0))
              : ((v += g(N.substr(0, F), !1, !0)), (v += N.substr(F))));
        }
        if (D) {
          if (
            D.length >= 3 &&
    ...
    Y(X[67], J([0, 1, 5, 9, 13, 14, 17, 6]), function (q, n, M, A, i, d, b, p) {
      ...
      class f {
        ...
        sendMessage(l, _) {
          ...
          return new Promise((v, R) => {
            ((this._pendingReplies[g] = { resolve: v, reject: R }),
      ...
      function w(s) {
        return (
          s[0] === "o" && s[1] === "n" && p.isUpperAsciiLetter(s.charCodeAt(2))
        );
      }
      function E(s) {
      ...
      function (q, n, M, A, i, d, b, p, h, o, L, e, a, u, c, m) {
        ...
        class f extends b.MirrorTextModel {
          ...
          findMatches(S) {
            ...
            for (let r = 0; r < this._lines.length; r++) {
              const s = this._lines[r],
                ...
                _ = s.matchAll(S);
              for (const g of _)
                ((g.index || g.index === 0) && (g.index = g.index + l),
                  C.push(g));
            }
            return C;
          }
          ...
          getValueInRange(S) {
            ...
            return (
              l.push(this._lines[s].substring(0, S.endColumn - 1)),
              l.join(C)
            );
          }
          offsetAt(S) {
        ...
        class y {
          ...
          _getModels() {
            const S = [];
            return (
              Object.keys(this._models).forEach((C) => S.push(this._models[C])),
              S
            );
          }
          acceptNewModel(S) {
          ...
          async computeMoreMinimalEdits(S, C, r) {
            ...
            for (let { range: v, text: R, eol: N } of C) {
              if ((typeof N == "number" && (_ = N), d.Range.isEmpty(v) && !R))
                continue;
            ...
            return this._foreignModuleFactory
              ...
              : new Promise((g, v) => {
                  q(
                    [S],
                    (R) => {
                      ((this._foreignModule = R.create(_, C)),
          ...
          fmr(S, C) {
            ...
            try {
              return Promise.resolve(
                this._foreignModule[S].apply(this._foreignModule, C),
              );
            } catch (r) {
